...
import utils.AuthNRequestBuilder;
...
public class LogInServiceImpl implements LogInService {
     ...
     */
    @Override
    public String getAuthNRedirectUrl(String idpAppURL, String assertionConsumerServiceUrl, String issuerId){

        LOGGER.debug("idpAppURL=" + idpAppURL + " assertionConsumerServiceUrl=" + assertionConsumerServiceUrl + " issuerId=" + issuerId);
        String url = null;
        ...
        try {
            ...
            // Prepare final Url
            url = idpAppURL + "?SAMLRequest=" + samlRequest ;
