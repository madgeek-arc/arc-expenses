...
public class RequestServiceImpl extends GenericService<Request> {
    ...
    public String createWhereClause(String email, String status,String searchField,String stage) {
        ...
        if(!stage.equals("all"))
            stage_clause += " request_stage = " + stage;

        whereClause+=stage_clause;

        if(!searchField.equals(""))
            search_clause+= " request_requester = " + searchField + " or " +
                            " request_project_operator = " + searchField + " or " +
                            " request_project_scientificCoordinator = " + searchField + " or  " +
                            " request_project = " + searchField + " or " +
                            " request_institute = " + searchField ;
